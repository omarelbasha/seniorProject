...
<div class="container">
  ...
  <form class="form-horizontal" method="post"  action="death"  enctype="multipart/form-data">
   <input type="hidden" name="cid" value=<%=a %>>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="mname" placeholder="Enter Father Name" name="mname"  required>
      </div>
    </div>
     <div class="form-group">
 ...
 <div class="form-group">
      <label class="control-label col-sm-2" for="dod">Date of death	:</label>
...
var n = d.getFullYear();
  ...
  document.write(" <option value='"+i+"'>"+i+"</option>");}
	...
	<div class="form-group">
      <label class="control-label col-sm-2" for="ab">Address of Death	:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="ab" placeholder="Enter Address of Death" name="ab">
      </div>
	  </div>
	 <div class="form-group">
      <label class="control-label col-sm-2" for="rel">Enter your Relation :</label>
      <div class="col-sm-10">          
 ...
 <div class="form-group">
      <label class="control-label col-sm-2" for="image">Enter your Death Report :</label>
      <div class="col-sm-10">          
