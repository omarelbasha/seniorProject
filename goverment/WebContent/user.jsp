...
<table border="1">
<tr><td>First Name</td><td>Last Name</td><td>Phone Number</td><td>Email</td><td>Access</td></tr>
<%

Connection c=DriverManager.getConnection("jdbc:mysql://localhost/sworddatabase", "root", "");
String sql="select * from users where verifiyed=0";
...
<a href="user2.jsp?id=<%=rs.getInt(1)%>">Accept</a> </tr>
<%} %>
</table>
</form>
</div>
