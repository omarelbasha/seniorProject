...
while(r.next()){
	...
	lname=r.getString(4);
	mname=r.getString(5);
	Relgion=r.getString(6);
	part=r.getString(14);
	partr=r.getString(15);
	add=r.getString(10);
	gen=r.getString(11);
	rn=r.getInt(8);
	dob=r.getString(9);
  ...
  <input type="hidden" name="cid" value=<%=a %>>
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="mothername" placeholder="Enter Mother Name" name="mothername"  value=<%=mname %> required>
      </div>
    </div>
	  <div class="form-group">
...
var n = d.getFullYear();
  ...
  document.write(" <option value='"+i+"'>"+i+"</option>");}
	...
	<div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="ab" placeholder="Enter Address of Birth" value=<%=add %> name="ab" required>
      </div>
	  </div>
	   <div class="form-group">
      <label class="control-label col-sm-2" for="rel">Religion	:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="rel" placeholder="Enter Religion" name="rel" value=<%=Relgion %> required>
      </div>
    </div>
	 <div class="form-group">
      <label class="control-label col-sm-2" for="pname">Partner Name	:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="pname" placeholder="Enter Partner Name" name="pname"  value=<%=part %>>
      </div>
    </div>
	 <div class="form-group">
      <label class="control-label col-sm-2" for="prel">Partner Religion	:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="prel" placeholder="Enter Partner Religion" name="prel"  value=<%=partr %>>
      </div>
	  </div>
	      <div class="form-group">
 ...
 <div class="form-group">
      <label class="control-label col-sm-2" for="image">Enter your photo :</label>
      <div class="col-sm-10">          
        <input type="file"  id="image"  name="image" accept=".jpg">
      </div>
	  </div>
	   <div class="form-group">
      <label class="control-label col-sm-2" for="image">Enter your Individual Civil Registry Record  :</label>
      <div class="col-sm-10">          
        <input type="file"  id="image"  name="cr" accept=".pdf">
      </div>
	  </div>
    <div class="form-group">        
